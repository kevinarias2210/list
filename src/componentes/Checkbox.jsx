import React, { Fragment } from "react"; //El fragment permite traer en un lista los hijos 

const Checkbox = (props) => {//En toda esta linea se trae los datos de las propiedades del formtodo, gracias al props
    const {
        onChange,
    ...
    return (
        <Fragment>
            {/*En este fragmento nos permite implementar varios elementos para que sea leido en el DOM, si se utilizara
            el div es muy mala practica*/}
            <svg
                viewBox="0 0 0 0"
